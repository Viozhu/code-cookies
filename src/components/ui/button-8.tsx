...
export const FriendlyButton = ({ onClick, className, children, text = "Let's Start Learning!" }: FriendlyButtonProps) => {
  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-300 via-blue-500 via-40% to-purple-500 px-4 py-2 text-white">
        ...
        <span className="font-semibold">{children || text}</span>
      </div>
      {!!particleState && (
        <Particles
          id="friendly-button-particles"
